 ...
 * @author jitor
 */
public class Gamelvl5 implements Initializable {
   ...
   private void initializeLabels() {
    ...
    private void saveStartLevel(){
         ...
         for(int row = 0; row < 11; row++){
             for(int column = 0; column < 19; column ++){
                 startLevel[row][column] = level5[row][column];   
            }      
        }    
    }
       ...
       private void savePreviousMove(){
        for (int row = 0; row < 11; row++) {
            for (int column = 0; column < 19; column++) {
                previousMatrix[row][column] = level5[row][column];
            }
        }
    }
    ...
    private void searchPlayer(){
        ...
        for (int row = 0; row < 11; row++) {
            for (int column = 0; column < 19; column++) {
                System.out.print(level5[row][column] + ",");
                if (level5[row][column] == 'P' || level5[row][column] == 'F') {    
                    playerRow = row;
                    playerColumn = column;
                    break;
                }    
   ...
   @FXML
    ...
    public void  finishedLevel(){
        ...
        if((level5[5][6] == 'M') && (level5[6][6] == 'M')&&
            (level5[7][6] == 'M') && (level5[8][8] == 'M') && (level5[4][10] == 'M')){
             btnSave.setDisable(true);
              btnRestart.setDisable(true);
    ...
    private void playerLeavingTheGoal(int newRow, int newColumn){
        ...
        if(level5[newRow][newColumn] == ' ' && level5[playerRow][playerColumn] == 'F'){
   
            savePreviousMove();
            level5[newRow][newColumn] = 'P';
            level5[playerRow][playerColumn] = '+';     
        }
    }
    
    public void playerMove(int newRow, int newColumn){
        
        if(level5[newRow][newColumn] == ' '){ 
    ...
    public void playerEnteringTheGoal(int newRow, int newColumn){
        ...
        if((level5[newRow][newColumn] == '+') && (level5[playerRow][playerColumn] == 'F')){
            ...
            savePreviousMove();
            btnOneStepBack.setDisable(false);
            level5[newRow][newColumn] = 'F';
            level5[playerRow][playerColumn] = '+'; 
        }
        else if(level5[newRow][newColumn] == '+'){
    ...
    public void checkIfBoxIsPushed(int newRow, int newColumn,int aux1,int aux2){
        ...
        if((level5[newRow][newColumn] == 'O' || level5[newRow][newColumn] == 'M') && level5[newRow + aux1][newColumn + aux2] != '#' 
            && level5[newRow + aux1][newColumn + aux2] != 'O' && level5[newRow + aux1][newColumn + aux2] != 'M'){
    ...
    private void pushOutGoalBox(int newRow, int newColumn, int aux1, int aux2){
        ...
        if(level5[newRow + aux1][newColumn + aux2] == '+' && level5[newRow][newColumn] == 'M' &&  level5[playerRow][playerColumn] == 'F'){
                
            savePreviousMove();
            level5[newRow + aux1][newColumn + aux2] = 'M';
            level5[newRow][newColumn] = 'F';
            level5[playerRow][playerColumn] = '+';
        }else if(level5[newRow + aux1][newColumn + aux2] == ' ' && level5[newRow][newColumn] == 'M' &&  level5[playerRow][playerColumn] == 'F'){  
            
            savePreviousMove();
            level5[newRow + aux1][newColumn + aux2] = 'O';
            level5[newRow][newColumn] = 'F';
            level5[playerRow][playerColumn] = '+';          
        }else if(level5[newRow + aux1][newColumn + aux2] == '+' && level5[newRow][newColumn] == 'M'){
            
            savePreviousMove();
            level5[newRow + aux1][newColumn + aux2] = 'M';
            level5[newRow][newColumn] = 'F';
            level5[playerRow][playerColumn] = ' '; 
        }else if(level5[newRow][newColumn] == 'M'){   
    ...
    private void pushBox(int newRow, int newColumn, int aux1, int aux2){
        ...
        if(level5[newRow + aux1][newColumn + aux2] == ' ' && level5[playerRow][playerColumn] == 'F'){
                
            savePreviousMove();
            level5[newRow + aux1][newColumn + aux2] = 'O';
            level5[newRow][newColumn] = 'P';
            level5[playerRow][playerColumn] = '+';
        }else if(level5[newRow + aux1][newColumn + aux2] == ' '){
    ...
    private void pushBoxToTheGoal(int newRow, int newColumn, int aux1, int aux2){
        ...
        if(level5[newRow + aux1][newColumn + aux2] == '+'){
    ...
    public void counterSteps(int newRow, int newColumn){
         ...
         if(level5[newRow][newColumn] != '#' &&  level5[newRow][newColumn] != 'O' &&  level5[newRow][newColumn] != 'M'){
            steps--;
            labSteps.setText(String.valueOf(steps));
        }
    }
    ...
    private void restartLevel(){
        ...
        for (int row = 0; row < 11; row++) {
            for (int column = 0; column < 19; column++) {
                level5[row][column] = startLevel[row][column];
            }
        }
        updateMap();  
    }
    ...
    private void gameLocked(){
        ...
        if(level5[4][8] == 'O' || level5[3][5] == 'O' || level5[8][9] == 'O' || level5[8][5] == 'O' || 
        level5[8][6] == 'O' || level5[3][12] == 'O' || level5[2][8] == 'O' ){
   ...
   private void saveGame(){
        ...
        String matrixlevel1 = matrixToString(level5);
    ...
    public void updateGame(){
        ...
        String matrixLevel5 = matrixToString(level5);
    ...
    public void loadGame(){
        ...
        if(option == 6){
            labPlayerName.setText(name);
            level5 = stringToMatrix(playerMatrix,11,19);
    ...
    private void clicklOneStepBack(ActionEvent event) {
        ...
        for (int row = 0; row < 11; row++) {
            for (int column = 0; column < 19; column++) {
                level5[row][column] = previousMatrix[row][column];
            }
        }
        updateMap();
